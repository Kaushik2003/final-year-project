...
\newcommand{\universityDetailsCoverPage}{%
  % \vfill
    \vspace{2cm}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{bibtext/snu_logo.jpg}\\[2ex]
    {\Large {Department of Computer Science}\\}
    {\Large \capitalisewords{Sister Nivedita University, Newtown}\\}
...
\newcommand{\supervisorDesignation}[1]{%
    ...
    {\normalfont \capitalisewords{Sister Nivedita University, Newtown}\\}
...
\newcommand{\universityDetailsTitlePage}{%
  % \vfill
   \vspace{0.2in}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{bibtext/snu_logo.jpg}\\[1ex]
    % {\Large\MakeUppercase{Department of Computer Science Engineering}\par}
    {\Large {Department of Computer Science}\par}
    {\Large \capitalisewords{Sister Nivedita University, Newtown}\par}
    {\Large \capitalisewords{Kolkata, West Bengal}}
